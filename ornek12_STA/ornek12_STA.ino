...
const char *ssid = "ESP8266";       // baglanilacak olan wifi aginin adi
const char *password = "12345678";  // baglanilacak olan wifi aginin sifresi
const char *sunucu = "192.168.4.1"; // baglanilacak olan sunucu adresi
